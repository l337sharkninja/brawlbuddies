...
$querydata = "INSERT INTO usermail (toid,fromid,sender,receiver,subject,message) VALUES ('{$_SESSION['mailData'][$i]['fromid']}','{$_SESSION['brawlid']}','{$_SESSION['mailData'][$i]['sender']}','{$_SESSION['alias']}','{$_POST['subject']}','{$_POST['message']}')";
...
echo "<body>";
	echo "<h1>Message {$_SESSION['mailData'][$i]['sender']}:</h1>";
