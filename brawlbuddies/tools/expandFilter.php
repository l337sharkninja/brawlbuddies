...
$originalcount = $_SESSION['counter'];
if($_SESSION['counterMax']<50){$_SESSION['counterLast']=$_SESSION['counterMax'];}
elseif($_SESSION['counter']<($_SESSION['counterMax']-50)){
	$_SESSION['counterLast']=$_SESSION['counter']-$_SESSION['counterMax']+50;
}else{$_SESSION['counterLast'] = $_SESSION['counter']+50;}
...
$firstrun=0;
if($_SESSION['counter']==$_SESSION['counterMax']){echo "<div class='col-lg-12 text-center row' style='position:relative;'>End of List</div>";break;}
require 'addCount.php';
}

$_SESSION['counter']=$originalcount;
/*
